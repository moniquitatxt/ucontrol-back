...
const char* topicWater = "Bano Mujeres/Escuela Ing. Informatica";
...
const String DEVICE_NAME = "Water Sensor" + NAMES_SEPARATOR + topicWater;
...
void loop() {
  ...
  if (c == '\n') {
    ...
    publishMessage(topicWater, mqtt_message, true);
