...
const char* topicPIR = "Puerta/Lab. Prototipos/Escuela Ing. Informatica";
...
const String DEVICE_NAME = "PIR Sensor" + NAMES_SEPARATOR + topicPIR;
...
void loop() {
  ...
  if (c == '\n') {
    ...
    publishMessage(topicPIR, mqtt_message, true);
